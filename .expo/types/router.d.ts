...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(modal)/adjust-meditation-duration` | `/(tabs)` | `/_sitemap` | `/adjust-meditation-duration` | `/affirmations` | `/nature-meditate`;
  type DynamicRoutes<T extends string> = `/${SingleRoutePart<T>}` | `/meditate/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/[itemId]` | `/meditate/[id]`;
